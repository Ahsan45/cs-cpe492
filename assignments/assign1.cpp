...
// • TOTP: Total number of products to be generated by all producer threads
// • QSIZE: Size of the queue to store products for both producer and consumer threads (0 for
...
int main(int argc, char* argv[]){
    ...
    for (i=0;i<NUMP;i++)
        pthread_create(&prod_thread[i],NULL, produce, NULL);
    ...
    for (i=0;i<NUMC;i++)
        pthread_create(&consmr_thread[i], NULL, consume, NULL);
